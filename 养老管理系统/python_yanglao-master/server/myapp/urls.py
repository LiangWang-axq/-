...
urlpatterns = [
    ...
    path('admin/health/list', views.admin.health.list_api),
    path('admin/health/create', views.admin.health.create),
    path('admin/health/update', views.admin.health.update),
    path('admin/health/delete', views.admin.health.delete),
    ...
    path('user/detail', views.admin.user.detail),  # 添加用户详情API
